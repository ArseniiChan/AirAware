...
export function HeatmapLayer({ hour }: HeatmapLayerProps = {}) {
  ...
  // Restored to the visual state at commit b21f3dd (4:12pm 2026-04-25):
  // heatmap kernel at low zoom (only AQI ≥ 70 contributes, tight radius)
  // crossfading into per-cell polygon fills at zoom 11+. No floor opacity
  // — clean blocks fade into the basemap.
  return (
